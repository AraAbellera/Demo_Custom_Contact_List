package sg.edu.rp.c346.id22014114.democustomcontactlist;
...
public class CustomAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        else
        {
            ...
            String imageUrl = "https://images.wagwalkingweb.com/media/daily_wag/blog_articles/hero/1662555079.3896947/5-best-mobile-apps-and-games-for-cats1.png";
